;; ------------------------------------------------------------------------
;; [Date Prev <msg00077.html>][Date Next <msg00079.html>] [Chronological]
;; <index.html#00078> [Thread] <threads.html#00078> [Top] </xemacs>
;; 
;; 
...
;;     * *Subject*: *Overkill cc-mode font-lock-keywords file*
;;     * *From*: *Chris Holt <xris@migraine.stanford.edu
;;       <mailto:xris@migraine.stanford.edu>>*
;;     * Date: 04 Jun 1998 18:26:56 -0700
;;     * Message-ID: <w37d8coljtr.fsf@vicarious.Stanford.EDU <msg00078.html>>
;;     * Newsgroups: *comp.emacs.xemacs*
;;     * Xref: uunet comp.emacs.xemacs:35438
;; 
;; ------------------------------------------------------------------------
;; 
;; I'm a big believer in font-locking, so much so that I wasn't satisfied with
;; the "Most" font-lock setting. Only having pre-defined types highlighted was
;; annoying, and c++ support wasn't great either. The code below is my solution
;; to the problem. It handles multiple variable declaration, struct/class and 
;; function declarations, and more. The same keywords are used for both c and
;; c++ files. 
;; 
;; I've tested it on xemacs-21 bXX, but there is nothing in it that shouldn't
;; work under 20.4. It highlights the standard template library correctly,
;; except for a few cases described in the comments. 
;; 
;; If you use this code and find a bug, please email me at
;; xris@migraine.stanford.edu. I don't read the newsgroup that often.
...
;;           o *Re: Overkill cc-mode font-lock-keywords file <msg00116.html>*
;;           + /From:/ Chris Holt <xris@migraine.stanford.edu>
;; 
;;     * Prev by Date: *tab key <msg00077.html>*
;;     * Next by Date: *Can I use ediff to review changes without source
;;       control? <msg00079.html>*
;;     * Index(es):
;;           o *Chronological* <index.html#00078>
;;           o *Thread* <threads.html#00078>
;; 
